...
# Создам структуру данных для всех блюд с правильными категориями и путями к изображениям

# Определяю все блюда по категориям
dishes_data = """
// storage.js - хранилище данных о блюдах
...
print("Данные блюд подготовлены")
print(f"\nВсего блюд: {dishes_data.count('new Dish')}")
print(f"Категорий: soup, main, salad, starter, drink, dessert")
